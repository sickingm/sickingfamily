...
--
-- Host: localhost
-- Generation Time: Oct 05, 2020 at 01:12 AM
...
CREATE TABLE `emails` (
  ...
  `email_type` varchar(6) CHARACTER SET latin1 NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(629, 45, 'sickngvo@swbell.net', 'home'),
...
(1148, 48, 'luke@sickingfamily.com', 'home'),
...
(1179, 1, 'aaron.branson@gmail.com', 'home'),
(1180, 4, 'maureenbranson@yahoo.com', 'home'),
(1183, 49, 'matt@sickingfamily.com', 'home'),
...
(1349, 67, 'neff.patrick@gmail.com', 'home'),
(1350, 67, 'patrick.neff@me.com', 'home'),
...
(1371, 131, 'gec005@gmail.com', 'home'),
...
(1406, 66, 'mwilhelm16@gmail.com', 'home'),
(1408, 121, 'mduffield@argusconsulting.com', 'home'),
(1433, 3, 'lukeabranson@gmail.com', 'home'),
(1438, 139, 'lbaeza76@gmail.com', 'home');
...
(3, 15, 'Luke', 'Branson', '#5 Stable  RIdge\r\nSt. Charles, MO 63301', '2001-04-08', '', 'LukeBb', 'amlfiam2735', 'N', 'self', 'N', 'N', 'N', 'M'),
...
(5, 9, 'Angela', 'Bubash', '1914 Senate St\r\nSaint Louis, MO 63118', '1989-04-07', '', 'Angela', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
...
(10, 9, 'Paul', 'Bubash', '4655 N Beacon St Apt 2\r\nChicago, IL 60640', '1990-09-17', '', 'PaulB', 'DBC', 'N', 'self', 'N', 'N', 'N', 'M'),
...
(19, 2, 'Katie', 'Lloyd', '10319 St. Dolores Dr.\r\nSt. Ann,  MO. 63074', '1978-10-27', 'BATHROOM JOKES UNLIMITED\r\nServing your potty humor needs since 1978.', 'Katie', 'DBC', 'N', 'self', 'N', 'N', 'N', 'F'),
(20, 11, 'Kiarra', 'Lloyd', '7057 Tholozan\r\nSt. Louis, MO  63109', '2001-09-22', '', 'Kiarra', 'Joseph', 'N', 'family', 'N', 'N', 'N', 'F'),
...
(41, 26, 'Marianne', 'Sicking', '9116 Slater\r\nOverland Park, KS 66212\r\n', '1989-02-06', '', 'Marianne', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
...
(45, 1, 'Jinny', 'Sicking', '10319 St. Dolores Dr.\r\nSt. Ann, MO 63074', '1924-10-22', '', 'Jinny', 'Joseph', 'N', 'clan', 'N', 'N', 'Y', 'F'),
...
(48, 4, 'Luke', 'Sicking', '11892 Archerton Drive\r\nBridgeon, MO 63044-2838', '1987-11-10', '', 'Luke', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
...
(53, 4, 'Adam', 'Sicking', '1252 Whitemoon Way Apt. F\r\nHazelwood, MO 63042  ', '1972-08-20', 'Call Adam on his cell phone.\r\nHe never answers his home phone.', 'Adam', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
...
(58, 5, 'Janet', 'Sicking', '8915 Wren Circle\r\nFountain Valley, CA 92708', '1955-12-27', '', 'Janet', 'Joseph', 'N', 'clan', 'Y', 'N', 'Y', 'F'),
...
(62, 8, 'Brian', 'Wilhelm', '10737 Oak Pointe Drive\r\nSaint Ann, MO  63074\r\n', '1993-09-14', '', 'Brian', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
(63, 8, 'Clare', 'Wilhelm', '10737 Oak Pointe Dr.\r\nSt. Ann, MO 63074', '1961-09-15', '', 'Clare', 'Joseph', 'N', 'clan', 'Y', 'Y', 'Y', 'F'),
(65, 8, 'Mark', 'Wilhelm', '10737 Oak Pointe Dr.\r\nSt. Ann, MO 63074', '1960-11-29', 'Go Blues!', 'MarkW', 'Joseph', 'N', 'clan', 'Y', 'N', 'Y', 'M'),
(66, 8, 'Mary', 'Wilhelm', '10737 Oak Pointe Drive\r\nSaint Ann, MO 63074', '1995-10-30', '', 'Mary', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
(67, 6, 'Patrick', 'Neff', '11721 Domain Blvd. \r\n#3444\r\nAustin, TX  78758', '1985-02-03', '', 'Patrick', '22121216', 'N', 'self', 'N', 'N', 'N', 'M'),
(68, 18, 'Wil', 'Valenzuela', '9212 Buttercup Ave.\r\nFountain Valley, CA 92708', '1949-07-09', 'Claire\'s godfather', 'Wil', 'Wil', 'N', 'self', 'Y', 'N', 'N', 'M'),
(69, 18, 'zzzGuest', 'zzzGuest', '', '2001-01-01', 'This is a bogus entry to allow trusted\r\nnon-family members access to this site \r\nfor things like the address book.\r\n(No privileges)\r\n\r\nMember name is \"guest\"\r\nPassword is \"GUEST\"', 'guest', 'guest', 'N', 'self', 'N', 'N', 'N', NULL),
...
(98, 18, 'Judy Budde', 'Dunn', '747 Dallas Drive\r\nSt. Louis, MO 63125', '2011-01-01', 'Favorite Cousin', 'JudyDunn', 'DBC', 'N', 'family', 'N', 'N', 'N', 'F'),
(99, 18, 'Mary', 'Budde', '361 Hoffmeister Avenue\r\nSt. Louis, MO 63125', '1922-12-08', 'Come visit any time!', 'MaryBudde', 'Budde', 'N', 'family', 'N', 'N', 'N', 'F'),
(102, 17, 'Monica', 'Steinbruegge', '1911 Country Acres Dr. \r\nSt. Peters, MO 63376', '2010-06-03', '', 'Monica', 'Joseph', 'N', 'family', 'N', 'N', 'N', 'F'),
(105, 23, 'Sarah', 'Platz', '3649 Vescovo\r\nSt. Louis, MO 63125', '1987-08-20', '', 'SarahP', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
...
(113, 19, 'Johnny', 'Sicking', '43 High Valley Dr.\r\nChesterfield, MO 63017-2763', '2012-11-13', 'I\'m the youngest. I\'m a Sicking!\r\nNot a Suffix any longer', 'Johnny', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
...
(120, 9, 'Dan', 'Thuet', '1914 Senate St\r\nSaint Louis, MO 63118 ', '1989-05-03', '', 'Dan', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
(121, 26, 'Mitch', 'Duffield', '9116 Slater\r\nOverland Park, KS 66212.', '1987-07-02', '', 'Mitch', 'Joseph', 'N', 'family', 'N', 'N', 'N', 'M'),
(122, 13, 'Jase', 'Malpocker', '1897 Hwy F\r\nWright City, MO  63390  ', '2013-12-06', '', 'Jase', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
(123, 25, 'Mike', 'Baker', '1209 Cashmere Lane \r\nSt. Peters MO 63376', '1969-09-19', '', 'MikeB', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
(124, 22, 'Maeve Jane Caroline', 'Pearce', '3348 E. Geddes Dr. \r\nCentennial, CO 80122', '2016-09-03', '', 'Maeve', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
(125, 27, 'Kaylin', 'McInerney', '1446 Cutter Avenue\r\nSt. Louis, MO 63139', '1992-03-31', '', 'Kaylin', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
(126, 28, 'Katy', 'Braden-McInerney', '1511 Sproule Avenue\r\nSt. Louis, MO 63139', '1991-06-18', '', 'Katy', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
(127, 28, 'Kevin Andrew', 'McInerney', '1511 Sproule Avenue\r\nSt. Louis, MO 63139', '1990-12-20', '', 'Kevin', 'DBC', 'N', 'self', 'N', 'N', 'N', 'M'),
(128, 17, 'Matthew', 'Steinbruegge', '1911 Country Acres Drive\r\nSt. Peters, MO 63376 ', '2018-11-20', '', 'Matthew', 'DBC', 'N', 'self', 'N', 'N', 'N', 'M'),
(131, 9, 'Ginger', 'Clements', '4655 N Beacon St Apt 2\r\nChicago, IL 60640', '1985-10-23', '', 'Ginger', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
(135, 29, 'Elizabeth', 'Wasielewski', '13038 Ferncrest Ct.\r\nCreve Coeur, MO 63141', '1989-09-15', '', 'Elizabeth', 'Joseph', 'N', 'family', 'N', 'N', 'N', 'F'),
(136, 29, 'Danny', 'Wasielewski', '13038 Ferncrest Ct.\r\nCreve Coeur, MO 63141', '1987-06-29', '', 'DannyWasie', 'Joseph', 'N', 'family', 'N', 'N', 'N', 'M'),
(137, 25, 'Jack', 'Baker', '1209 Cashmere Lane\r\nSt. Peters, MO 63376', '2017-05-29', '', 'Jack', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'M'),
(138, 25, 'Molly Ann ', 'Baker ', '1209 Cashmere Drive\r\nSt. Peters, MO 63376', '2018-12-17', '', 'Molly', 'Joseph', 'N', 'self', 'N', 'N', 'N', 'F'),
(139, 1, 'Laura', 'Baeza,', '', '1945-01-01', '', 'LauraB', 'Dk', 'N', 'self', 'N', 'N', 'N', 'F');
...
CREATE TABLE `names` (
  ...
  `priv` enum('none','Admin','','') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'none',
  `email` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `ans` enum('Y','M','N','') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
INSERT INTO `names` (`name_id`, `first_name`, `last_name`, `priv`, `email`, `ans`) VALUES
(2, 'Jeannette', 'Sicking', '', 'jeannette@sickingfamily.com', 'N'),
(9, 'Margie', 'Diethelm', '', 'margiedhelm@gmail.com', 'N'),
(11, 'Rich', 'Fischer', '', 'richnpat1@sbcglobal.net', 'N'),
(15, 'Yvonne', 'Hill', '', 'lightchaos62@gmail.com', 'N'),
(18, 'Charlie', 'Kromer', '', 'charlieoh40@charter.net', 'N'),
(25, 'Dave', 'Wixom', '', 'lightchaos62@gmail.com', 'N'),
(27, 'Eunice', 'Gray', '', 'egray12@charter.net', 'N'),
(31, 'Dick', 'Bossch', '', 'richardbossch@gmail.com', 'N'),
(36, 'Pat', 'Fischer', '', 'richnpat1@sbcglobal.net', 'N'),
(38, 'Sue', 'Bossch', '', 'sue.bossch@gmail.com', 'N');
...
(1136, 45, '314-550-1097', 'cell'),
(1137, 45, '314-428-7163', 'home'),
...
(1390, 65, '314-330-1535', 'cell'),
(1391, 65, '314-434-2713', 'fax'),
(1392, 65, '314-434-4545', 'work'),
(1393, 65, '314-428-2737', 'home'),
(1534, 74, '314-303-9769', 'home'),
(1561, 53, '314-313-9891', 'cell'),
(1562, 53, '314-291-0600', 'work'),
...
(1769, 48, '314-739-3722', 'home'),
(1770, 48, '314-494-9870', 'cell'),
...
(1836, 1, '314-692-2823', 'work'),
(1837, 1, '314-482-9589', 'cell'),
(1838, 1, '314-252-0802', 'home'),
(1839, 4, '314-252-0802', 'home'),
(1840, 4, '314-322-9711', 'cell'),
(1848, 49, '314-452-6677', 'cell'),
(1849, 49, '314-739-3722', 'home'),
...
(1966, 19, '239-287-0220', 'cell'),
(1968, 10, '314-255-9057', 'cell'),
(1977, 27, '636-448-5817', 'cell'),
(1979, 26, '314-651-3855', 'cell'),
(1984, 62, '314-539-1080', 'cell'),
(1985, 62, '314-428-2737', 'home'),
(1986, 63, '314-428-2737', 'home'),
(1987, 63, '314-740-7536', 'cell'),
(1988, 63, '314-875-4412', 'work'),
(1990, 120, '314-603-0745', 'cell'),
...
(2088, 66, '314-428-2737', 'home'),
(2089, 66, '314-599-3449', 'cell'),
(2091, 121, '816-309-4245', 'cell'),
(2092, 88, '314-252-0802', 'home'),
(2105, 3, '314-252-0802', 'home'),
(2106, 3, '314-452-8954', 'cell'),
(2112, 79, '314-252-0802', 'home'),
(2124, 110, '314-252-0802', 'home');
...
(342, 'A Very Fine Event Indeed.......', '', 49, 'public');
...
(1, 342, 'Aaron\'w comment'),
(4, 342, 'Another Comment'),
(5, 342, 'Here\'s a comment'),
(7, 342, 'I\'m commenting here'),
(8, 342, 'qwertyuiopasdfghjkl'),
(40, 342, 'EMPTY COMMENTS'),
(47, 342, 'EMPTY COMMENTS'),
(49, 342, 'EMPTY COMMENTS'),
(51, 342, 'EMPTY COMMENTS'),
(73, 342, 'EMPTY COMMENTS');
...
CREATE TABLE `wccw_ynm` (
  ...
  `event_ptr` bigint(20) NOT NULL,
  `ynm` enum('Y','N','M','?') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `wccw_ynm`
--

INSERT INTO `wccw_ynm` (`ynm_member_id`, `ynm_date_id`, `event_ptr`, `ynm`) VALUES
(1, '2020-09-28', 342, 'Y'),
(1, '2020-09-29', 342, 'Y'),
(1, '2020-09-30', 342, 'Y'),
(4, '2020-09-28', 342, 'Y'),
...
--
ALTER TABLE `clans`
  MODIFY `clan_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `emails`
--
ALTER TABLE `emails`
  MODIFY `email_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1439;
...
--
ALTER TABLE `phones`
  MODIFY `phone_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2125;

--
-- AUTO_INCREMENT for table `wccw_events`
--
ALTER TABLE `wccw_events`
  MODIFY `event_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=343;
...
--
-- Constraints for table `wbw`
--
ALTER TABLE `wbw`
  ADD CONSTRAINT `wbw_ibfk_1` FOREIGN KEY (`event_ptr`) REFERENCES `events` (`event_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `wbw_ibfk_2` FOREIGN KEY (`member_ptr`) REFERENCES `members` (`member_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `wccw_dates`
--
ALTER TABLE `wccw_dates`
  ADD CONSTRAINT `date_cascade_on_event` FOREIGN KEY (`event_ptr`) REFERENCES `wccw_events` (`event_id`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Constraints for table `wccw_invitees`
--
ALTER TABLE `wccw_invitees`
  ADD CONSTRAINT `Invitee_cascade_on_event` FOREIGN KEY (`event_ptr`) REFERENCES `wccw_events` (`event_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `invitee_cascade_on_member` FOREIGN KEY (`invitee_id`) REFERENCES `members` (`member_id`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Constraints for table `wccw_ynm`
--
ALTER TABLE `wccw_ynm`
  ADD CONSTRAINT `avail_cascade_on_date` FOREIGN KEY (`ynm_date_id`) REFERENCES `wccw_dates` (`date`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `avail_cascade_on_event` FOREIGN KEY (`event_ptr`) REFERENCES `wccw_events` (`event_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `avail_cascade_on_member` FOREIGN KEY (`ynm_member_id`) REFERENCES `members` (`member_id`) ON DELETE CASCADE ON UPDATE RESTRICT;
COMMIT;
