<?php	identifier_comment("BEGIN " . __FILE__ ." Line # " . __LINE__ . " FUNCTION: ". __FUNCTION__); ?>
	...
	<div align='center' id='top'>
	    ...
	    <form method='POST' name='new_event' action='_wccw.php?cmd=new' id='input_form'>
	        ...
	        <input type='submit' value='Save Event' name='save_event' onclick='checkSubmit();'>
	        <input type='reset' value='Reset' name='reset'>
	    </form>
	    <form method='GET' action='../_wccw/_wccw.php?cmd=list'>
